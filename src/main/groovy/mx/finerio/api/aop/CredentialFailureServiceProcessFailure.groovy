...
@Component
@Aspect
class CredentialFailureServiceProcessFailure {

  final static Logger log = LoggerFactory.getLogger(
      'mx.finerio.api.aop.CredentialFailureServiceProcessFailure' )

  @Pointcut(
    value='execution(void mx.finerio.api.services.CredentialFailureService.processFailure(..)) && bean(credentialFailureService) && args(failureCallbackDto)',
