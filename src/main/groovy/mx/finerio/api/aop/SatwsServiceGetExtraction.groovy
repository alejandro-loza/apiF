...
@Component
@Aspect
class SatwsServiceGetExtraction {

  final static Logger log = LoggerFactory.getLogger(
      'mx.finerio.api.aop.SatwsServiceGetExtraction' )

  @Pointcut(
    value='execution(java.util.Map mx.finerio.api.services.SatwsService.getExtraction(..)) && bean(satwsService) && args(extractionId)',
