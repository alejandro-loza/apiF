...
@Component
@Aspect
class SatwsServiceGetTaxReturn {

  final static Logger log = LoggerFactory.getLogger(
      'mx.finerio.api.aop.SatwsServiceGetTaxReturn' )

  @Pointcut(
    value='execution(java.util.Map mx.finerio.api.services.SatwsService.getTaxReturn(..)) && bean(satwsService) && args(taxReturnId)',
