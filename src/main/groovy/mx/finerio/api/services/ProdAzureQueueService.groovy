...
@Service
@Profile('prod')
class ProdAzureQueueService implements AzureQueueService {


  final static Logger log = LoggerFactory.getLogger(
    'mx.finerio.api.services.ProdAzureQueueService' )
  ...
  @Autowired
  public ProdAzureQueueService (@Value('${servicebus.azure.transactions.stringConnection}') final String serviceUrl, 
